...
* [Akira](https://github.com/akiraux/Akira) ⭐ 5,334 | 🐛 41 | 🌐 Vala | 📅 2025-12-30 -  Native Linux App for UI and UX Design built in Vala and GTK.
* [Birdfont](https://github.com/johanmattssonm/birdfont) ⭐ 550 | 🐛 79 | 🌐 Vala | 📅 2025-11-23 - A font editor for creating fonts in TTF, EOT, SVG and BIRDFONT format.

### Development Tools

* [GitG](https://gitlab.gnome.org/GNOME/gitg) - A graphical user interface for [git](https://git-scm.com/).
* [Kangaroo](https://github.com/dbkangaroo/kangaroo) ⭐ 514 | 🐛 16 | 🌐 TSQL | 📅 2026-07-31 - AI-powered SQL client and admin tool for popular databases.
...
* [Korembi](https://github.com/cheesecakeufo/komorebi) ⭐ 3,750 | 🐛 290 | 🌐 Vala | 📅 2025-07-21 - A beautiful and customizable wallpapers manager for Linux.

### Productivity

* [Planify](https://github.com/alainm23/planify) ⭐ 5,576 | 🐛 165 | 🌐 Vala | 📅 2026-08-04 - Task manager with Todoist support designed for GNU/Linux.
* [Dino](https://github.com/dino/dino) ⭐ 2,476 | 🐛 679 | 🌐 Vala | 📅 2026-08-05 - A modern Jabber/XMPP Client using GTK+/Vala.
* [pdfpc](https://github.com/pdfpc/pdfpc) ⭐ 1,857 | 🐛 31 | 🌐 Vala | 📅 2026-04-23 - A GTK presenter application with multi-monitor support for PDF files.
...
* [Notejot](https://github.com/lainsce/notejot) ⭐ 415 | 🐛 0 | 🌐 Vala | 📅 2025-10-05 - Stupidly-simple notes app.
* [Annotator](https://github.com/phase1geo/Annotator) ⭐ 275 | 🐛 8 | 🌐 Vala | 📅 2026-07-17 - Annotate images for better communication.
...
* [SwayNotifiationCenter](https://github.com/ErikReider/SwayNotificationCenter) ⭐ 2,556 | 🐛 108 | 🌐 Vala | 📅 2026-06-25 - A simple GTK based notification daemon for SwayWM.
* [elementary OS App Center](https://github.com/elementary/appcenter) ⭐ 550 | 🐛 164 | 🌐 Vala | 📅 2026-08-07 - Pay-what-you-can app store for elementary OS.
* [Monitor](https://github.com/stsdc/monitor) ⭐ 361 | 🐛 36 | 🌐 Vala | 📅 2026-08-01 - Manage processes and monitor system resources.
...
* [vala-language-server](https://github.com/vala-lang/vala-language-server) ⭐ 332 | 🐛 82 | 🌐 Vala | 📅 2026-08-09 - A language server that aims to provide code completion, formatting, syntax highlighting, and everything else according to the Language Server spec.
...
* [Graphene](https://github.com/ebassi/graphene) ⭐ 433 | 🐛 18 | 🌐 C | 📅 2025-12-19 - A thin layer of types for graphic libraries. It provides common types needed to handle 3D transformations: points, triangles, rectangles, quads, quaternions, vectors, matrices, spheres, etc.
