...
* [Akira](https://github.com/akiraux/Akira) ⭐ 5,342 | 🐛 41 | 🌐 Vala | 📅 2025-12-30 -  Native Linux App for UI and UX Design built in Vala and GTK.
* [Birdfont](https://github.com/johanmattssonm/birdfont) ⭐ 557 | 🐛 79 | 🌐 Vala | 📅 2025-11-23 - A font editor for creating fonts in TTF, EOT, SVG and BIRDFONT format.

### Development Tools

* [Kangaroo](https://github.com/dbkangaroo/kangaroo) ⭐ 518 | 🐛 16 | 🌐 TSQL | 📅 2026-09-05 - AI-powered SQL client and admin tool for popular databases.
...
* [Warble](https://github.com/avojak/warble) ⭐ 89 | 🐛 5 | 🌐 Vala | 📅 2024-11-05 - Native Linux word-guessing game built in Vala and Gtk for elementary OS.
...
* [Starfish](https://github.com/starfish-app/Starfish) ⭐ 35 | 🐛 18 | 🌐 Vala | 📅 2022-07-31 - A Gemini browser for elementary OS.
...
* [Korembi](https://github.com/cheesecakeufo/komorebi) ⭐ 3,762 | 🐛 290 | 🌐 Vala | 📅 2025-07-21 - A beautiful and customizable wallpapers manager for Linux.

### Productivity

* [Planify](https://github.com/alainm23/planify) ⭐ 5,697 | 🐛 177 | 🌐 Vala | 📅 2026-09-18 - Task manager with Todoist support designed for GNU/Linux.
* [Dino](https://github.com/dino/dino) ⭐ 2,492 | 🐛 685 | 🌐 Vala | 📅 2026-08-21 - A modern Jabber/XMPP Client using GTK+/Vala.
* [pdfpc](https://github.com/pdfpc/pdfpc) ⭐ 1,873 | 🐛 32 | 🌐 Vala | 📅 2026-04-23 - A GTK presenter application with multi-monitor support for PDF files.
* [TextSnatcher](https://github.com/RajSolai/TextSnatcher) ⭐ 1,389 | 🐛 43 | 🌐 Vala | 📅 2024-03-20 - Copy text from Images with ease.
* [Minder](https://github.com/phase1geo/Minder) ⭐ 1,202 | 🐛 50 | 🌐 Vala | 📅 2026-09-12 - Mind-mapping application.
...
* [Annotator](https://github.com/phase1geo/Annotator) ⭐ 280 | 🐛 9 | 🌐 Vala | 📅 2026-08-26 - Annotate images for better communication.
...
* [TextShine](https://github.com/phase1geo/TextShine) ⭐ 19 | 🐛 2 | 🌐 Vala | 📅 2026-07-17 - Convert and manipulate text.
...
* [SwayNotifiationCenter](https://github.com/ErikReider/SwayNotificationCenter) ⭐ 2,585 | 🐛 115 | 🌐 Vala | 📅 2026-06-25 - A simple GTK based notification daemon for SwayWM.
* [elementary OS App Center](https://github.com/elementary/appcenter) ⭐ 553 | 🐛 166 | 🌐 Vala | 📅 2026-09-20 - Pay-what-you-can app store for elementary OS.
* [Monitor](https://github.com/stsdc/monitor) ⭐ 361 | 🐛 50 | 🌐 Vala | 📅 2026-09-21 - Manage processes and monitor system resources.
...
* [Valdo](https://github.com/vala-lang/valdo) ⭐ 56 | 🐛 9 | 🌐 Vala | 📅 2026-05-13 - Create new Vala projects from templates.
...
* [Vamposer](https://github.com/ValaTux/vamposer) ⭐ 1 | 🐛 4 | 🌐 Vala | 📅 2026-08-11 - Dependency manager for Vala projects inspired by Composer/Go modules and integrated with Meson subprojects.
...
* [vala-language-server](https://github.com/vala-lang/vala-language-server) ⭐ 334 | 🐛 81 | 🌐 Vala | 📅 2026-08-27 - A language server that aims to provide code completion, formatting, syntax highlighting, and everything else according to the Language Server spec.
...
* [Graphene](https://github.com/ebassi/graphene) ⭐ 438 | 🐛 18 | 🌐 C | 📅 2025-12-19 - A thin layer of types for graphic libraries. It provides common types needed to handle 3D transformations: points, triangles, rectangles, quads, quaternions, vectors, matrices, spheres, etc.
...
* [Almanna ORM](https://github.com/AmbitionFramework/almanna) ⭐ 8 | 🐛 1 | 🌐 Vala | 📅 2022-07-04 -  The Almanna ORM for Vala/GLib.

### Graphics Libraries

* [live-chart](https://github.com/lcallarec/live-chart) ⭐ 80 | 🐛 14 | 🌐 Vala | 📅 2025-01-24 - A real-time charting library for Vala and GTK3 based on Cairo.
...
* [balistica](https://github.com/fusilero/libbalistica) ⭐ 12 | 🐛 4 | 🌐 Vala | 📅 2020-08-27 - An open source ballistic simulation library. There's a complete calculator [here](https://github.com/fusilero/balistica) ⭐ 67 | 🐛 9 | 🌐 Vala | 📅 2026-07-29.
