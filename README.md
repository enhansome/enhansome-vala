...
* [Akira](https://github.com/akiraux/Akira) ⭐ 5,341 | 🐛 41 | 🌐 Vala | 📅 2025-12-30 -  Native Linux App for UI and UX Design built in Vala and GTK.
* [Birdfont](https://github.com/johanmattssonm/birdfont) ⭐ 556 | 🐛 79 | 🌐 Vala | 📅 2025-11-23 - A font editor for creating fonts in TTF, EOT, SVG and BIRDFONT format.
...
* [Korembi](https://github.com/cheesecakeufo/komorebi) ⭐ 3,758 | 🐛 289 | 🌐 Vala | 📅 2025-07-21 - A beautiful and customizable wallpapers manager for Linux.

### Productivity

* [Planify](https://github.com/alainm23/planify) ⭐ 5,685 | 🐛 174 | 🌐 Vala | 📅 2026-09-10 - Task manager with Todoist support designed for GNU/Linux.
* [Dino](https://github.com/dino/dino) ⭐ 2,489 | 🐛 684 | 🌐 Vala | 📅 2026-08-21 - A modern Jabber/XMPP Client using GTK+/Vala.
* [pdfpc](https://github.com/pdfpc/pdfpc) ⭐ 1,872 | 🐛 32 | 🌐 Vala | 📅 2026-04-23 - A GTK presenter application with multi-monitor support for PDF files.
...
* [Annotator](https://github.com/phase1geo/Annotator) ⭐ 279 | 🐛 9 | 🌐 Vala | 📅 2026-08-26 - Annotate images for better communication.
...
* [SwayNotifiationCenter](https://github.com/ErikReider/SwayNotificationCenter) ⭐ 2,582 | 🐛 114 | 🌐 Vala | 📅 2026-06-25 - A simple GTK based notification daemon for SwayWM.
* [elementary OS App Center](https://github.com/elementary/appcenter) ⭐ 554 | 🐛 166 | 🌐 Vala | 📅 2026-09-14 - Pay-what-you-can app store for elementary OS.
* [Monitor](https://github.com/stsdc/monitor) ⭐ 362 | 🐛 44 | 🌐 Vala | 📅 2026-09-15 - Manage processes and monitor system resources.
...
* [vala-language-server](https://github.com/vala-lang/vala-language-server) ⭐ 335 | 🐛 81 | 🌐 Vala | 📅 2026-08-27 - A language server that aims to provide code completion, formatting, syntax highlighting, and everything else according to the Language Server spec.
...
* [Graphene](https://github.com/ebassi/graphene) ⭐ 437 | 🐛 18 | 🌐 C | 📅 2025-12-19 - A thin layer of types for graphic libraries. It provides common types needed to handle 3D transformations: points, triangles, rectangles, quads, quaternions, vectors, matrices, spheres, etc.
